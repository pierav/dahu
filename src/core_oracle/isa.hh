...
class StaticInst {
    ...
    uint64_t _rd() { return x(7, 5); }
    uint64_t _rs1() { return x(15, 5); }
    uint64_t _rs2() { return x(20, 5); }
    uint64_t _rs3() { return x(27, 5); }
    uint64_t _rm() { return x(12, 3); }
    uint64_t _csr() { return x(20, 12); }
    uint64_t _iorw() { return x(20, 8); }
